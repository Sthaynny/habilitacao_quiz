# Features — Habilitação Quiz

Especificações para apresentação e implementação. Cada arquivo é autocontido; tarefas detalhadas estão em [../tasks/A_FAZER.md](../tasks/A_FAZER.md).

| ID doc | Título | Onda |
| :--- | :--- | :---: |
| [modelo-free-pro.md](./modelo-free-pro.md) | Dois apps, ProGate, matriz revisada | 1 |
| [promocao-quiz-plus.md](./promocao-quiz-plus.md) | Substituir AdMob por promo do **+** | 1 |
