# Engenharia — Habilitação Quiz

Documentação para implementação consistente (humanos e agentes em `.cursor/agents/`).

| Doc | Uso |
| :--- | :--- |
| [flutter-architecture.md](./flutter-architecture.md) | Clean Architecture, GetX, ProGate, rotas |
